...
namespace WPFUITemplate2.ViewModels.Pages.BasicInput
{
        ...
        public ThumbRateState ThumbRateState
        {
            ...
            set
            {
                ...
                ThumRateStateCodeText =
                    $"<ui:ThumbRate State=\"{(value switch { ThumbRateState.Liked => "Liked", ThumbRateState.Disliked => "Disliked", _ => "None" })}\" />";
            }
        }
    }
