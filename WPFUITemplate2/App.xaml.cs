...
using WPFUITemplate2.ViewModels.Pages;
...
using WPFUITemplate2.Views.Pages.BasicInput;
using WPFUITemplate2.Views.Pages.Collections;
using WPFUITemplate2.Views.Pages.DateAndTime;
using WPFUITemplate2.Views.Pages.DesignGuidance;
using WPFUITemplate2.Views.Pages.DialogsAndFlyouts;
using WPFUITemplate2.Views.Pages.Layout;
using WPFUITemplate2.Views.Pages.Media;
using WPFUITemplate2.Views.Pages.Navigation;
using WPFUITemplate2.Views.Pages.Samples;
using WPFUITemplate2.Views.Pages.StatusAndInfo;
using WPFUITemplate2.Views.Pages.Text;
using WPFUITemplate2.Views.Pages.Windows;
