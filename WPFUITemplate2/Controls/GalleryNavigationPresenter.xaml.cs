    ...
    public class GalleryNavigationPresenter : System.Windows.Controls.Control
    {
        ...
        public static readonly DependencyProperty TemplateButtonCommandProperty =
            DependencyProperty.Register(
                ...
                typeof(Wpf.Ui.Common.IRelayCommand),
                typeof(GalleryNavigationPresenter),
                new PropertyMetadata(null)
            );
        ...
        /// </summary>
        public Wpf.Ui.Common.IRelayCommand TemplateButtonCommand =>
            (Wpf.Ui.Common.IRelayCommand)GetValue(TemplateButtonCommandProperty);
        ...
        public GalleryNavigationPresenter()
        {
            SetValue(
                ...
                new Wpf.Ui.Common.RelayCommand<Type>(o => OnTemplateButtonClick(o))
            );
        }
